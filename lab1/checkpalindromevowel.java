...
public class  checkpalindromevowel {
    JFrame f;
    JLabel l1,l2;
    JTextField t1;
    JButton b1,b2,b3;
    public  checkpalindromevowel(){
        f = new JFrame("Check Palindrome,Vowel & Reverse");
        l1 = new JLabel("Input any String =");
        t1= new JTextField(30);
        b1 = new JButton("Check Palindrome");
        b2 = new JButton("Reversed");
        ...
        b1.setBounds(20, 40, 150, 20);
        b2.setBounds(180, 40, 150, 20);
        b3.setBounds(350, 40, 150, 20);
        ...
        b1.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if(sb.reverse().toString().equals(ss.toString()))
                {
